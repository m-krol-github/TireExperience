...
import skyscraperModel from "../../assets/objects/Usa/Skyscraper_1.glb";
...
export function Skyscraper1({ index }) {
  ...
  return (
    <mesh
      castShadow
      receiveShadow
      geometry={nodes.Skyscraper_1.geometry}
...
useGLTF.preload(skyscraperModel);
useTexture.preload([skyscraperBase, skyscraperNormal]);
